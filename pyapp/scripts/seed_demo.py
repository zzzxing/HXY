    ...
    try:
        ...
        db.add_all([
            ...
            ActivitySite(
                ...
                order_index=3,
                intro="城市生活与工业记忆展示区",
                key_facts="关注生活变化与工业联系",
                hotspots=json.dumps(["老照片墙", "工人日记", "城市地图"], ensure_ascii=False),
                problem_chain=json.dumps([{"level": "核心问题", "content": "工业发展如何影响城市生活？"}], ensure_ascii=False),
                evidence_checklist=json.dumps(["记录1条生活线索", "形成1条解释"], ensure_ascii=False)
            ),
        ])
