...
import { demoCases, demoSites, demoState } from '@/lib/demo/store';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 lg:grid-cols-4">
        ...
        <Card><p className="text-xs text-muted">当前主题</p><p className="font-semibold">{demoCases[0].title}</p></Card>
      ...
      <Card>
        ...
        <div className="mt-3 flex flex-wrap gap-3 text-sm">
          ...
          <Link className="text-primary" href="/teacher/cases">案例工作台</Link>
          <Link className="text-primary" href="/teacher/cases/case-hs-001/tasks">任务布置</Link>
          <Link className="text-primary" href={`/teacher/activities/demo-activity-1/students`}>学生进度与档案评价</Link>
        </div>
      </Card>
    </div>
  );
