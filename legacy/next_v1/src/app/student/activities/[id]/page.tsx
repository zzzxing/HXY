  ...
  return (
    <div className="space-y-4">
      <Card className="bg-white/90">
        <h1 className="text-2xl font-bold">{demoActivity.title}</h1>
        <p className="mt-1 text-sm text-muted">{demoActivity.description}</p>
        <div className="mt-3 flex flex-wrap gap-3 text-sm">
          <Link href={`/student/activities/${demoActivity.id}/visit`} className="text-primary">路线 / 地图</Link>
